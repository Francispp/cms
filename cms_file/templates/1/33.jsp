				...
				<table border="0" cellPadding="0" cellSpacing="0" class="myTab_ab">
					<tbody>
						<tr>
							...
							<td colSpan="3"><ww:textfield cssClass="textField_ab" cssStyle="width: 400px" id="TextField_6372192687" name="domain.title"></ww:textfield></td>
						</tr>
						<tr>
						...
						<tr>
							<td colSpan="4"><ww:textarea cssClass="max-length-null" id="Html_4068798281" name="domain.body"></ww:textarea><script type="text/javascript"></script><%com.ckeditor.CKEditorConfig ckConfig_Html_4068798281 = new com.ckeditor.CKEditorConfig();ckConfig_Html_4068798281.addConfigValue("filebrowserImageUploadUrl", pageContext.getAttribute("ctx")+"uploadFile!uploadCK.action?file.fileType=image&file.docId="+request.getAttribute("id")+"&file.channelId="+request.getAttribute("channelId")+"&file.fieldName=domain.body");ckConfig_Html_4068798281.addConfigValue("filebrowserFlashUploadUrl", pageContext.getAttribute("ctx")+"uploadFile!uploadCK.action?file.fileType=flash&file.docId="+request.getAttribute("id")+"&file.channelId="+request.getAttribute("channelId")+"&file.fieldName=domain.body");%><ckeditor:replace basePath="/common/ckeditor/" config="<%=ckConfig_Html_4068798281%>" replace="domain.body"></ckeditor:replace></td>
						</tr>
						<tr>
							<td align="right" height="30" width="150">附件：</td>
							<td colSpan="3"><div class="attachment_default"> <s:if test='isEdit'><div class = "but_img" onclick="newAttachment(window.Upload_0787667624,'','','${domain.id}','${domain.site.oid}','','attachs','50');"></div></s:if>
<div id="Upload_0787667624"></div></div><script type="text/javascript"> <s:if test='isEdit'> viewAttachment(window.Upload_0787667624,'','${domain.id}','attachs');
</s:if><s:else> viewAttachmentForDetailsTemplate(window.Upload_0787667624,'','${domain.id}','attachs');
</s:else></script></td>
						</tr>
						<tr>
							...
							<td colSpan="4" vAlign="top">
								<table border="0" cellPadding="0" cellSpacing="0" width="100%">
									<tbody>
										...
										<tr>
											<td vAlign="top">
												<table cellpadding="3" cellspacing="1" class="history_dataGrid" id="History_3490841917" width="100%"><tr class="header"><td class="td_username">&#29992;&#25143;&#21517;</td><td class="td_time">&#26102;&#38388;</td></tr><%{
