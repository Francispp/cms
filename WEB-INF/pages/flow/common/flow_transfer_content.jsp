          ...
          <table width="94%" border="0" cellspacing="0" cellpadding="0" >
            <tr>
              <td><table width="100%" border="0" cellpadding="0" cellspacing="0" id="a1">
                ...
                <tr>
                  <td align="left" class="zi"><ww:if test="(flows!=null&&flows.size>0)">转移活动人员</ww:if><ww:if test="(flows==null||flows.size==0)">&nbsp;&nbsp;您转移的活动不存在！</ww:if></td>
                </tr>
                <tr>
...
<script language="javascript">
 ...
 //提交页面
  function doConfirm(){
   ...
   //var url=replaceAll(window.location.href,'!transact','!tranfer');
   //myform.action=url;
   // myform.submit(); 
   var rtStr='tranfer!'+document.getElementById('NodeSelectUserIds').value;
