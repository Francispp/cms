...
<tr align=center>
	<!--td class="card" onclick="cardClick(1)" id="card1">打开前执行</td>
	<td width=2></td>
	<td class="card" onclick="cardClick(2)" id="card2">打开后执行</td-->
	<td width=2></td>
	<td onclick="cardClick(1)" id="card1">保存前执行</td>
	<td width=2></td>
	<td onclick="cardClick(2)" id="card2">保存后执行</td>
	<td width=2></td>
	<!--td class="card" onclick="cardClick(5)" id="card5">退出时执行</td-->
	<td width=2></td>
</tr>
...
<tr>
	...
	<tr>
		<td bgcolor="#FFFFFF" width="15%">打开前执行</td>
		<td bgcolor="#FFFFFF" width="85%"><textarea name="beforopenscript" cols="40" rows="15" id="beforopenscript"></textarea>
		</td>
	</tr>
	</table>
	<table width="100%"  cellpadding="2" cellspacing="1"  border="0"  bgcolor="#dddddd" id="content2">
	<tr>
		<td bgcolor="#FFFFFF" width="15%">打开后执行</td>
		<td bgcolor="#FFFFFF" width="85%">
		<textarea name="afteropenscript" cols="40" rows="15" id="afteropenscript"></textarea>
		</td>
	</tr>
	</table-->
