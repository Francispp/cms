  ...
  <div class="info-box">
			...
			<ec:column property="CMS_DOCUMENT_UNISSUE" title="取消发布" editable="false" filterable="false" />
<ec:column property="CMS_DOCUMENT_ADD" title="新增文档" editable="false" filterable="false" />
...
<c:if test="${objectType!=type}">
<ec:column property="CMS_DOC_MENU" title="文档工作台" editable="false" filterable="false" />
</c:if>
<ec:column property="CMS_DOCUMENT_MODI" title="修改文档" editable="false" filterable="false" />
<ec:column property="CMS_DOCUMENT_VIEW" title="查看文档" editable="false" filterable="false" />
<ec:column property="CMS_DOCUMENT_DELETE" title="删除文档" editable="false" filterable="false" />
<c:if test="${objectType!=type}">
<ec:column property="CMS_DOCUMENT_VIEW_AUTHOR" title="查看文档(作者)" editable="false" filterable="false" />
</c:if>
<c:if test="${objectType!=type}">
<ec:column property="CMS_DOCUMENT_MODI_AUTHOR" title="修改文档(作者)" editable="false" filterable="false" />
</c:if>
<c:if test="${objectType!=type}">
<ec:column property="CMS_DOCUMENT_DELETE_AUTHOR" title="删除文档(作者)" editable="false" filterable="false" />
</c:if>
<ec:column property="CMS_DOCUMENT_ISSUE" title="文档发布" editable="false" filterable="false" />
