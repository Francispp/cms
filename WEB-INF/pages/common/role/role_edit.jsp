...
<script type='text/javascript' src='/dwr/interface/RoleManagerService.js'></script>
...
function save(){
	var id = document.getElementById("domain.oid").value;
  	var rolecode = document.getElementById("domain.rolecode").value;
	...
	if(valid.validate()){
		...
		var siteId = document.getElementById("domain.siteId").value;
		RoleManagerService.dwrCoreRoleValidateRolecodeUnique(id,rolecode,str,siteId,
			function(data){ 
				if (data == "0") {
					alert("角色代码重复或外部角色组拼重复,请仔细检查!");
					document.getElementById("domain.rolecode").focus();
					return;	
				}
	  			myform.submit();
			} 
...
<form class="pw-borderOut_ab pw-w617_ab" method="post" action="${ctx}/cms/cmsrole!saveOrUpdate.action" name="myform">
</c:if>
<c:if test="${rolestatus!='site'}">
<form class="pw-borderOut_ab pw-w617_ab" method="post" action="role!saveOrUpdate.action" name="myform">
</c:if>
				...
				<li class="pw-con-input-item_ab">
                    <label class="lab-pw_ab">
                       ...
                       <ww:textfield name="domain.rolename" 
							cssClass="required  max-length-50 textField_ab textField-w150_ab"/>
                    </label>
                </li>
              <li class="pw-con-input-item_ab">
                    <label class="lab-pw_ab">
               ...
               <li class="pw-con-input-item_ab" id="roleIdentity_1">
                    <label class="lab-pw_ab">
                    	<span class="lab-pw-tit_ab">
                         ...
                         <ww:select  name="domain.roleIdentity" id="selectRoleIdentity" list="#request.coreIdentityList" listKey="icode" listValue="iname" cssClass="select_ab select-w150_ab"/>
                     </label>
                </li>
               ...
               <li class="pw-con-input-item_ab" id="LDAP_TR" style="position:absolute;width:600px;">
                    <label class="lab-pw_ab">
                     ...
                     <ww:textarea
							name="domain.relationContent"  cssClass="max-length-60  textarea-hb select-w150_ab" rows="6" cssStyle="width:400px;height:100px;"/>
							 </label>
                </li>
            </ul>
            ...
            <ul class="pw-con-input_ab pw-con-input-ex_ab" style="height:264px;">
             ...
             <li class="pw-con-input-item_ab">
                    <label class="lab-pw_ab">
                       ...
                       <ww:textfield
							name="domain.rolecode" id="domain.rolecode" cssClass="required  max-length-40  textField_ab textField-w150_ab" />
                    </label>
                </li>
                 <li class="pw-con-input-item_ab">
                    <label class="lab-pw_ab">
                     ...
                     <ww:select name="domain.state"
							list="trueOfFalseMap2" cssClass="select_ab select-w150_ab required"/>
							 </label>
                </li>
                 <li class="pw-con-input-item_ab">
                    <label class="lab-pw_ab">
                    	<span class="lab-pw-tit_ab">
                         ...
                         <ww:textfield
							name="domain.remark" cssClass="max-length-40  textField_ab textField-w150_ab" />
                    </label>
                </li>
                 <li class="pw-con-input-item_ab">
                    <label class="lab-pw_ab">
                 ...
                 <li class="pw-con-input-item_ab" id="roleIdentity_1_1">
                    <label class="lab-pw_ab">
                        ...
                        <select id="CMS2List" style="vertical-align:middle;WIDTH:150px;height:130px" size="10" name="CMS2List"></select>
...
<c:if test="${not empty actionMessages}">
	 <script type="text/javascript">
	try{
	  	parent.frames['switchToTree'].location.reload();
