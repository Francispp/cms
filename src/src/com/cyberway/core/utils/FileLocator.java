...
public class FileLocator {
	...
	public URL getURL(String location) throws BizException {
		...
		try {
			...
			throw new BizException("装载配置文件错误", e);
		}
		if (url == null) {
			throw new BizException("读取配置文件为空",
					new Throwable("读取配置文件为空"));
		}

		return url;
	}

	public InputStream loadResource(String location) throws BizException {
