...
public class StringUtil {
	...
	public static String EncodingHTML(String arg0) {
		String encodeStr = arg0;
		encodeStr = encodeStr.replaceAll("&amp;","&");
		encodeStr = encodeStr.replaceAll("&quot;","\"");
		encodeStr = encodeStr.replaceAll("&lt;","<");
...
public static List<String> splitList(String s,String delimiter){
	...
	public static String parseParam(String str, Map map) {
		...
		for (int j = 0; j < left; j++) {
			// 取参数名
			temp = parseStr.substring(parseStr.indexOf("{") + 1, parseStr
					.indexOf("}"));
			al.add(temp);
