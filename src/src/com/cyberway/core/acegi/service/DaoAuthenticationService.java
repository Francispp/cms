...
public class DaoAuthenticationService extends JdbcDaoSupport implements AuthenticationService{
	...
	public List<User> getUsers() {
		...
		for (Iterator iter = users.iterator(); iter.hasNext();) {
			...
			.execute(new Object[] {user.getUsername()});
    ...
    protected class AuthoritiesByUsernameMapping extends MappingSqlQuery {
        ...
        protected Object mapRow(ResultSet rs, int rownum)
            throws SQLException {
            String roleId = rolePrefix + rs.getString(1);
            GrantedAuthorityImpl authority = new GrantedAuthorityImpl(roleId);
            return authority;
        }
    }
    ...
    protected class LoadResourcesMapping extends MappingSqlQuery {
        ...
        protected Object mapRow(ResultSet rs, int rownum)
            ...
            if(resString !=null && resType != null)
            {
