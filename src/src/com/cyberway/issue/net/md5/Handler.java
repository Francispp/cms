/* $Id: Handler.java 4566 2006-08-31 16:51:41Z stack-sf $
 *
 ...
 */
package com.cyberway.issue.net.md5;
 ...
 * {@link com.cyberway.issue.net.DownloadURLConnection#getFile()} to get name of
 * temporary file.
 * 
 * <p>You need to define the system property
 * <code>-Djava.protocol.handler.pkgs=com.cyberway.issue.net</code> to add this handler
 * to the java.net.URL set. Also define system properties
 * <code>-Dcom.cyberway.issue.net.md5.Md5URLConnection.path=PATH_TO_SCRIPT</code> to
 * pass path of script to run as well as
 * <code>-Dcom.cyberway.issue.net.md5.Md5URLConnection.options=OPTIONS</code> for
    ...
    throws IOException {  
        if (args.length != 1) {
            System.out.println("Usage: java java " +
                "-Djava.protocol.handler.pkgs=com.cyberway.issue.net " +
                "com.cyberway.issue.net.md5.Handler " +
                "md5:deadbeefdeadbeefdeadbeefdeadbeef");
            System.exit(1);
        }
        System.setProperty("com.cyberway.issue.net.md5.Md5URLConnection.path",
            "/tmp/manifest");
        System.setProperty("java.protocol.handler.pkgs", "com.cyberway.issue.net");
