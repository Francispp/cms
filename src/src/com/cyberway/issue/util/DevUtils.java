...
/**
 * Write a message and stack trace to the 'com.cyberway.issue.util.DevUtils' logger.
 *
 * @author gojomo
...
public class DevUtils {
    ...
    /**
     * Log a warning message to the logger 'com.cyberway.issue.util.DevUtils' made of
