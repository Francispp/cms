/* SettingsHandler
 *
 * $Id: SettingsHandler.java 5504 2007-10-03 20:01:02Z gojomo $
 *
...
import com.cyberway.issue.crawler.framework.Checkpointer;
import com.cyberway.issue.crawler.framework.ToeThread;
import com.cyberway.issue.crawler.settings.refinements.Refinement;
...
public abstract class SettingsHandler {
    ...
    private final static String names[][] = new String[][] {
            ...
            { TEXT, "com.cyberway.issue.crawler.settings.TextField"},
            { OBJECT, "com.cyberway.issue.crawler.settings.ModuleType"},
            { TIMESTAMP, "java.util.Date"},
            { MAP, "com.cyberway.issue.crawler.settings.MapType"},
            { INTEGER_LIST,
                    "com.cyberway.issue.crawler.settings.IntegerList"},
            { LONG_LIST, "com.cyberway.issue.crawler.settings.LongList"},
            { FLOAT_LIST, "com.cyberway.issue.crawler.settings.FloatList"},
            { DOUBLE_LIST, "com.cyberway.issue.crawler.settings.DoubleList"},
            { STRING_LIST, "com.cyberway.issue.crawler.settings.StringList"}};
