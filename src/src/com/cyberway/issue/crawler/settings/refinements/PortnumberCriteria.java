 ...
 */
package com.cyberway.issue.crawler.settings.refinements;
...
public class PortnumberCriteria implements Criteria {
    ...
    /* (non-Javadoc)
     * @see com.cyberway.issue.crawler.settings.refinements.Criteria#isWithinRefinementBounds(com.cyberway.issue.crawler.datamodel.UURI, int)
     */
    ...
    /* (non-Javadoc)
     * @see com.cyberway.issue.crawler.settings.refinements.Criteria#getName()
     */
    ...
    /* (non-Javadoc)
     * @see com.cyberway.issue.crawler.settings.refinements.Criteria#getDescription()
     */
