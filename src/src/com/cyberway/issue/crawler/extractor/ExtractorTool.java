...
import com.cyberway.issue.util.OneLineSimpleLogger;
...
//        Logger.getLogger(ExtractorTool.class.getName());
    ...
    private static final String [] DEFAULT_EXTRACTORS =
        {"com.cyberway.issue.crawler.extractor.ExtractorHTTP",
            "com.cyberway.issue.crawler.extractor.ExtractorHTML"};
