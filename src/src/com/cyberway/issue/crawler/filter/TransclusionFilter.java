 ...
 * $Header$
 */
package com.cyberway.issue.crawler.filter;
...
import com.cyberway.issue.crawler.deciderules.DecidingFilter;
...
//  private static final String TRANSCLUSION_PATH = ".*[PREX][PREX]?[PREX]?$";
    ...
    /* (non-Javadoc)
     * @see com.cyberway.issue.crawler.framework.Filter#innerAccepts(java.lang.Object)
     */
