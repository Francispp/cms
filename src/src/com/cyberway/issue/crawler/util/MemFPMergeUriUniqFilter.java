...
public class MemFPMergeUriUniqFilter extends FPMergeUriUniqFilter {
    ...
    /* (non-Javadoc)
     * @see com.cyberway.issue.crawler.util.FPMergeUriUniqFilter#beginFpMerge()
     */
    ...
    /* (non-Javadoc)
     * @see com.cyberway.issue.crawler.util.FPMergeUriUniqFilter#addNewFp(java.lang.Long)
     */
    ...
    /* (non-Javadoc)
     * @see com.cyberway.issue.crawler.util.FPMergeUriUniqFilter#finishFpMerge()
     */
    ...
    /* (non-Javadoc)
     * @see com.cyberway.issue.crawler.datamodel.UriUniqFilter#count()
     */
    public long count() {
        return allFps.size();
    }
