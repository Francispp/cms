...
import com.cyberway.issue.crawler.filter.FilePatternFilter;
import com.cyberway.issue.crawler.filter.TransclusionFilter;
...
public class PathScope extends SeedCachingScope {
    ...
    private static Logger logger =
        Logger.getLogger("com.cyberway.issue.crawler.basic.PathScope");
