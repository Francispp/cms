...
//import com.cyberway.issue.crawler.filter.OrFilter;
...
public class ClassicScope extends CrawlScope {
    ...
    private com.cyberway.issue.crawler.filter.OrFilter excludeFilter;
    ...
    public ClassicScope(String name) {
        ...
        addElementToDefinition(new SimpleType(ATTR_MAX_TRANS_HOPS,
            ...
            new Integer(5)));
        this.excludeFilter = (com.cyberway.issue.crawler.filter.OrFilter)
            addElementToDefinition(new com.cyberway.issue.crawler.filter.OrFilter(
                ATTR_EXCLUDE_FILTER));
