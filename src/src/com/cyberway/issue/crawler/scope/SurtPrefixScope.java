...
import com.cyberway.issue.crawler.deciderules.DecidingScope;
...
import com.cyberway.issue.util.SurtPrefixSet;
...
public class SurtPrefixScope extends RefinedScope {
    ...
    /* (non-Javadoc)
     * @see com.cyberway.issue.crawler.framework.CrawlScope#initialize(com.cyberway.issue.crawler.framework.CrawlController)
     */
     ...
     * 
     * @see com.cyberway.issue.crawler.framework.CrawlScope#kickUpdate()
     */
