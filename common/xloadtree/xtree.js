...
function WebFXTree(sText, sAction, sBehavior, sIcon, sOpenIcon,sId,sOnMouseup) {
	this.base = WebFXTreeAbstractNode;
	this.base(sText, sAction);
	this.icon      = sIcon || webFXTreeConfig.rootIcon;
	this.openIcon  = sOpenIcon || webFXTreeConfig.openRootIcon;
	this.treeId=sId;
	this.onmouseup=sOnMouseup;
	/* Defaults to open */
	if (webFXTreeConfig.usePersistence) {
...
WebFXTree.prototype.toString = function() {
	var str = "<div id=\"" + this.id + "\" ondblclick=\"webFXTreeHandler.toggle(this);\" class=\"webfx-tree-item\" onkeydown=\"return webFXTreeHandler.keydown(this, event)\">" +
		...
		"<a href=\"" + this.action + "\" id=\"" + this.id + "-anchor\" name=\""+this.treeId+"\"  onfocus=\"webFXTreeHandler.focus(this);\" onmouseup=\""+this.onmouseup+"\" onblur=\"webFXTreeHandler.blur(this);\"" +
...
function WebFXTreeItem(sText, sAction, eParent, sIcon, sOpenIcon,sId,sOnMouseup) {
	this.base = WebFXTreeAbstractNode;
	this.base(sText, sAction);
	/* Defaults to close */
	if (webFXTreeConfig.usePersistence) {
