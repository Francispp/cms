 ...
 */
package com.cyberway.issue.net.rsync;
 ...
 * system property
 * <code>-Dcom.cyberway.issue.net.rsync.RsyncUrlConnection.path=PATH_TO_RSYNC</code> to
    ...
    throws IOException {
        if (args.length != 1) {
            System.out.println("Usage: java java " +
                ...
                "com.cyberway.issue.net.rsync.Handler RSYNC_URL");
            System.exit(1);
        }
