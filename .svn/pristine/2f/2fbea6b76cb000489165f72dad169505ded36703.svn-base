var Checkbox = FormField.extend(
{
	initialize : function ()
	{
		this.parent ("input", "Checkbox", "CMS_CHECKBOX", "checkbox", "340", "400", "复选框");
		...
		{
			SetAttribute (component, "type", "checkbox");
		});
		...
		this.addEvent ("onPageInitialize", function (component)
		{
			if (component)
			{
				...
				$("valueField").value = GetAttribute (component, "fieldValue");
				$("valueFieldNo").value = GetAttribute (component, "fieldValueNo");
		...
		this.addEvent ("onComponentInitialize", function (component)
		{
			...
			SetAttribute(component, "fieldValue", $("valueField").value);
			SetAttribute(component, "fieldValueNo", $("valueFieldNo").value);
			if($("readOnlyPrivilegeScriptField"))
