          ...
          <table width="94%" border="0" cellspacing="0" cellpadding="0" >
            <tr>
              <td><table width="100%" border="0" cellpadding="0" cellspacing="0" id="a1">
                ...
                <tr>
                  <td align="left" class="zi"><ww:if test="(flows!=null&&flows.size>0)">下一步活动</ww:if><ww:if test="(flows==null||flows.size==0)">&nbsp;&nbsp;您是否要结果整个流程？</ww:if></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td align="left"><table width="100%" border="0" cellpadding="1" cellspacing="1" class="td2">
                      <tr>
...
<script language="javascript">
 ...
 //提交页面
  ...
  // myform.submit(); 
  //transact:comple
   var rtStr='comple!'+document.getElementById('NodeSelectUserIds').value;
