...
var _menuDir="../common/menu/";
var _MenuImagesDir = _menuDir+"images/";
...
Menu.prototype.cssFile = _menuDir+"menu.css";
...
Menu.prototype.show = function ( left, top, w, h ) {
	...
	this.drawMenu();
	/*
	if(this.cssFile!=_menuDir+"css/menu.css"){
		var a = this.popup.document.getElementById("_CSS0");
		a.href=_menuDir+"css/menu.css";
		this.cssFile=_menuDir+"css/menu.css";
	}	
