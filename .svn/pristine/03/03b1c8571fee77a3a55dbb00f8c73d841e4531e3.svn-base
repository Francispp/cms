...
function WebFXTree(sText, sAction, sBehavior, sIcon, sOpenIcon,sRadio,sCheckBox,sValue,sChecked,sSelectClick,sOnMouseup) {
	...
	this.selectClick=sSelectClick;
	this.selectName="selCheckObj";
	this.selectId="selCheckObj";
	if(sValue) this.selectId="tsid_"+sValue;	
	
	if (sOnMouseup){this.onmouseup=sOnMouseup;}
...
WebFXTree.prototype.toString = function() {
	...
	if(this.radio=="Y"||this.radion=="y"||this.radio=="true"){
		if(this.selectClick!=null&&this.selectClick!="")//caiw add
		     selectedstr+=" onclick=\""+this.selectClick+"\"";
		...
		if(this.checked=="Y"||this.checked=="y"||this.checked=="true"){		
			...
			selectedstr=this.checked
			}
		if(this.selectClick!=null&&this.selectClick!="")//caiw add
		     selectedstr+=" onclick=\""+this.selectClick+"\"";
		str+="<input type=\"Checkbox\" id=\""+this.selectId+"\" name=\""+this.selectName+"\" value=\""+svalue+"\" "+selectedstr+">";
	}
		
		str+="<a href=\"" + this.action + "\" id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\"  onmouseup=\""+this.onmouseup+"\"  onblur=\"webFXTreeHandler.blur(this);\"" +
...
//get current select string
WebFXTree.prototype.getSelectIdsValid = function() {
	var str = "";
	try{
		var sels = document.getElementsByName("selRadioObj");
		var size = sels.length;
...
function WebFXTreeItem(sText, sAction, eParent, sIcon, sOpenIcon,sRadio,sCheckBox,sValue,sChecked,sSelectClick,sOnMouseup) {
	this.base = WebFXTreeAbstractNode;
	this.base(sText, sAction);
	...
	this.selectName="selCheckObj";
	this.selectId="selCheckObj";
	if(sValue) this.selectId="sid_"+sValue;
	if (sOnMouseup){this.onmouseup=sOnMouseup;}
