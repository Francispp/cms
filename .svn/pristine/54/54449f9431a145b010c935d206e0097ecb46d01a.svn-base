								...
								function saveGird(buttonObj,formid){
								 ...
								 function insertObject(roleType){						 
								  ...
								  obj[3]=${objectType};
 								  ...
 								  obj[5]=${type};	
 								  if(obj[1]!=null && obj[1]!='')							 
								   ExecuteService("if(reply.getResult()=='true'){window.location=window.location+'&time='+document.myform.userId.value;}else alert(str);",'cmsPermissionService','insertPermission',obj);								 
								 }
  ...
  <ul id="lion-ul">
    ...
    <!--li id="button1"><a href="javascript:insertObject(3);">增加部门</a></li-->
	 <li class="artEdit-btn_ab artEdit-btn-w3letters_ab">
             <a class="artEdit-btn-in_ab" href="${ctx}/cms/permission.action?type=${type}&objectType=${objectType}&objectId=${objectId}&comstatus=2">
...
<ec:column property="CMS_DOCUMENT_EXPORT" title="数据导出" editable="false" filterable="false" />
</c:if>
<c:if test="${objectType!=type}">
<ec:column property="CMS_DOCUMENT_IMPORT" title="数据导入" editable="false" filterable="false" />
</c:if>
<c:if test="${objectType!=type}">
<ec:column property="CMS_DOCUMENT_HEADLINE" title="设置头条" editable="false" filterable="false" />
</c:if>
<ec:column property="CMS_CAMPUS_RESUME" title="校园招聘简历" editable="false" filterable="false" />
<ec:column property="CMS_SOCIAL_RESUME" title="社会招聘简历" editable="false" filterable="false" />
<ec:column property="CMS_COURSE" title="课程管理" editable="false" filterable="false" />
<ec:column property="CMS_TUTOR" title="导师管理" editable="false" filterable="false" />
<ec:column property="CMS_QUESTIONNAIRE" title="问卷管理" editable="false" filterable="false" />
<ec:column property="CMS_Site_EMAIL" title="邮件模板" editable="false" filterable="false" />
<ec:column property="CMS_IN_USER" title="员工管理" editable="false" filterable="false" />
<c:if test="${objectType!=type}">
<ec:column property="CMS_SITE_RECYCLE_MANAGER" title="回收站" editable="false" filterable="false" />
</c:if>
<c:if test="${objectType!=type}">
<ec:column property="CMS_SITE_OVERDUE_DOC" title="过期文档管理" editable="false" filterable="false" />
</c:if>
<c:if test="${objectType!=type}">
<ec:column property="CMS_SITE_ISSUE_PERMISSION_MANAGER" title="站点分发管理" editable="false" filterable="false" />
</c:if>
<ec:column property="CMS_SITE_MENU" title="站点管理" editable="false" filterable="false" />
<ec:column property="CMS_SITE_VIEW" title="浏览站点" editable="false" filterable="false" />
<ec:column property="CMS_IDENTITY_MANAGEMENT " title="身份管理" editable="false" filterable="false" />
<ec:column property="CMS_SITE_ADD" title="新增站点" editable="false" filterable="false" />
<ec:column property="CMS_SITE_MODI" title="修改站点" editable="false" filterable="false" />
<ec:column property="CMS_SITE_DELETE" title="删除站点" editable="false" filterable="false" />
<c:if test="${objectType!=type}">
<ec:column property="CMS_SITE_TYPE" title="类别管理" editable="false" filterable="false" />
</c:if>
<ec:column property="CMS_SITE_DYNAMIC_PUBLISHING" title="站点动态发布" editable="false" filterable="false" />
<c:if test="${objectType!=type}">
<ec:column property="CMS_SITE_DOCUMENT_PERMISSION_MANAGER" title="站点文档权限管理" editable="false" filterable="false" />
</c:if>
<ec:column property="CMS_SITE_ROLE_MANAGER" title="角色管理" editable="false" filterable="false" />
<ec:column property="CMS_DATA_MENU" title="数据与服务" editable="false" filterable="false" />
<ec:column property="CMS_ACCESS_STATISTICS" title="访问统计" editable="false" filterable="false" />
<c:if test="${objectType!=type}">
<ec:column property="CMS_COMMONLY_TYPE" title="类别管理" editable="false" filterable="false" />
</c:if>
<ec:column property="CMS_STATIC_LIBRARY" title="静态资源库" editable="false" filterable="false" />
<ec:column property="CMS_MEDIA_MENU" title="媒体库" editable="false" filterable="false" />
<ec:column property="CMS_VIDEO_LIBRARY" title="视频库" editable="false" filterable="false" />
<ec:column property="CMS_AUDIO_LIBRARY" title="音频库" editable="false" filterable="false" />
<ec:column property="CMS_STATIC_MENU" title="采集与分发" editable="false" filterable="false" />
<ec:column property="CMS_DISTRIBUTING_CONFIGURATION" title="分发配置" editable="false" filterable="false" />
<ec:column property="CMS_SITE_COLLECTION" title="站点采集" editable="false" filterable="false" />
<ec:column property="CMS_SITE_DISTRIBUTING" title="站点分发" editable="false" filterable="false" />
