...
import com.cyberway.issue.crawler.datamodel.InstancePerThread;
...
import com.cyberway.issue.util.HttpRecorderMarker;
import com.cyberway.issue.util.ProgressStatisticsReporter;
...
Reporter, ProgressStatisticsReporter {
    ...
    private static Logger logger =
        Logger.getLogger("com.cyberway.issue.crawler.framework.ToeThread");
     ...
     * 
     * @see com.cyberway.issue.util.HttpRecorderMarker
     */
...
//                    System.out.println((memAfter-memBefore)+"K in "+currentProcessorName);
     ...
     * @see com.cyberway.issue.util.HttpRecorderMarker#getHttpRecorder()
     */
