...
<tabbar  hrefmode="iframe">
    <row>
      ...
      <!--//   <cms:CmsAuth resCode="CMS_TEMPLATE_MANAGER" objectId="${id}" objectType="1">
       <tab id="b2" width='100px' href="${ctx}/cms/template!list.action?siteId=${id}&amp;templateType=5">首页模板</tab>
      ...
      <!--   <cms:CmsAuth resCode="CMS_SITE_MODI" objectId="${id}" objectType="1">
         <tab id="b5" selected="1" width='100px' href="${ctx}/cms/permission.action?type=1&amp;objectId=${id}&amp;objectType=1">站点权限管理</tab>
       </cms:CmsAuth>   
       <cms:CmsAuth resCode="CMS_SITE_DOCUMENT_PERMISSION_MANAGER" objectId="${id}" objectType="1">
