							...
							<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
									<tr>
										...
										<form method="post" action="${ctx}/login!logon.action"
...
<div id="login2">
<!--Copyright by Cyberway Compucomm Co.,Ltd. All Rights Reserved.2007　　有任何疑问，请联系<a href="#"><font color="ff0000">系统管理员</font></a><br /> -->
</div>
</td></tr>
</table>
