...
import com.cyberway.issue.util.fingerprint.LongFPSet;
...
public abstract class AbstractLongFPSet implements LongFPSet, Serializable {
    private static Logger logger =
        Logger.getLogger("com.cyberway.issue.util.AbstractLongFPSet");
     ...
     *
     * @see com.cyberway.issue.util.fingerprint.LongFPSet#contains(long)
     */
     ...
     *
     * @see com.cyberway.issue.util.fingerprint.LongFPSet#count()
     */
    public long count() {
        return count;
    }
     ...
     *
     * @see com.cyberway.issue.util.fingerprint.LongFPSet#add(long)
     */
     ...
     *
     * @see com.cyberway.issue.util.fingerprint.LongFPSet#quickContains(long)
     */
