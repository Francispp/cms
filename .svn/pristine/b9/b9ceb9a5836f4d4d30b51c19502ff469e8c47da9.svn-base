/* StatisticsSummary
 * 
 * $Id: StatisticsSummary.java 4666 2006-09-26 17:53:28Z paul_jack $$
 * 
	    	...
	    	while (line != null) {
	    		...
	    		if (items.length < 3) {
	    			...
	    			if (crawlStatus.equals("CRAWLED")) {
	    				crawlStatus =com.cyberway.issue.crawler.framework.StatisticsTracking.SEED_DISPOSITION_SUCCESS;	    		  
	    			}
	    			else {
	    				crawlStatus = com.cyberway.issue.crawler.framework.StatisticsTracking.SEED_DISPOSITION_FAILURE;
	    			}
