...
public class ScopePlusOneDecideRule extends SurtPrefixedDecideRule {
     ...
     *@see com.cyberway.issue.crawler.deciderules.SurtPrefixedDecideRule#getPrefixes()
     */
     ...
     * prefixes.
     * @param o Context object.
     * @see com.cyberway.issue.crawler.deciderules.SurtPrefixedDecideRule#readPrefixes()
     */
