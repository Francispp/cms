...
function selectUser(key)
{
   ...
   if(key.indexOf("'")!=-1){
	...
	var url="${ctx}/base/role!searchRole.action?keys="+encodeURI(key);
	//alert(url);
	LoadData(myXML,url);
	var inn = "";
...
<tr >
<td   bgcolor="#FFFFFF" width='62%'  valign="top" style="height:100%;">

<table width=100% height=100% border=0 cellpadding="2" cellspacing="2" bgcolor="#C4E1FF">
<tr  ><td bgcolor="#FFFFFF" valign=top style="height:100%;">
