...
// About User
DlgUserGeneralTab	: "基本 ",
DlgUserValueScriptTab	: "值脚本 ",
DlgUserJudgeScriptTab	: "校验脚本 ",
DlgUserHiddenScriptTab	: "隐藏脚本 ",
DlgUserPopedomTab     	: "权限控制 ",
DlgUserName    	        : "名称：",
DlgUserStyle    	: "样式选择：",
DlgUserSystemDefault    : "系统默认",
DlgUserDescribe    	: "描述：",
DlgUserValueScript    	: "值脚本：",
DlgUserOneself    	: "自定义",
DlgUserMustFillScript   : "生成必填脚本",
DlgUserHiddenScript    	: "隐藏脚本：",
DlgUserPopedom    	: "权限资源：",
DlgUserWriteScript    	: "生成编辑权限脚本：",
DlgUserInputType   	: "文本框类型：",
DlgUserNormalInput   	: "普通",
DlgUserHiddenInput  	: "隐藏",
DlgUserPasswordInput  	: "密码",
DlgUserSelect   	: "选择：",
DlgDocRightMenu   	: "禁止右键",
DlgDocNoOnSelect   	: "禁止选择",
DlgUserMoreSelect   	: "允许多选："
