...
import com.cyberway.issue.crawler.settings.ValueErrorHandler;
 ...
 *
 * @see com.cyberway.issue.crawler.settings.ValueErrorHandler
 */
public class CrawlJobErrorHandler implements ValueErrorHandler {
     ...
     * {@link com.cyberway.issue.crawler.settings.Constraint.FailedCheck
     * FailedCheck} objects.
     *
     * @return an list of all encountered errors (with level equal to
     *         or higher then current level).
     *
     * @see com.cyberway.issue.crawler.settings.Constraint.FailedCheck
     */
