...
package com.cyberway.cms.site.objects;
...
public class SimpleJob implements Job {
	...
	public void execute(JobExecutionContext context)
		...
		if(context.getJobDetail().getJobDataMap().containsKey("siteid"))
			logger.info("siteid:"+context.getJobDetail().getJobDataMap().getString("siteid"));
