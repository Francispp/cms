/* Frontier
 *
 * $Id: Frontier.java 5794 2008-03-24 19:51:46Z gojomo $
 *
...
import com.cyberway.issue.crawler.frontier.FrontierJournal;
 ...
 * {@link com.cyberway.issue.crawler.framework.CrawlController CrawlController} which
 * is in turn responsible for providing access to it. Most significant among
 * those modules interested in the Frontier are the
 * {@link com.cyberway.issue.crawler.framework.ToeThread ToeThreads} who perform the
 ...
 * of interest to {@link com.cyberway.issue.crawler.framework.StatisticsTracking
 ...
 * {@link com.cyberway.issue.crawler.event.CrawlURIDispositionListener
 * CrawlURIDispostionEvents} by invoking the proper methods on the
 * {@link com.cyberway.issue.crawler.framework.CrawlController CrawlController}.
 * Doing this allows a custom built
 * {@link com.cyberway.issue.crawler.framework.StatisticsTracking
 ...
 * {@link com.cyberway.issue.crawler.settings.ModuleType ModuleType}
 ...
 *
 * @see com.cyberway.issue.crawler.framework.CrawlController
 * @see com.cyberway.issue.crawler.framework.CrawlController#fireCrawledURIDisregardEvent(CrawlURI)
 * @see com.cyberway.issue.crawler.framework.CrawlController#fireCrawledURIFailureEvent(CrawlURI)
 * @see com.cyberway.issue.crawler.framework.CrawlController#fireCrawledURINeedRetryEvent(CrawlURI)
 * @see com.cyberway.issue.crawler.framework.CrawlController#fireCrawledURISuccessfulEvent(CrawlURI)
 * @see com.cyberway.issue.crawler.framework.StatisticsTracking
 * @see com.cyberway.issue.crawler.framework.ToeThread
 * @see com.cyberway.issue.crawler.framework.FrontierHostStatistics
 * @see com.cyberway.issue.crawler.settings.ModuleType
 */
public interface Frontier extends Reporter {
     ...
     *
     * @see com.cyberway.issue.crawler.settings.ModuleType#ModuleType(String)
     */
