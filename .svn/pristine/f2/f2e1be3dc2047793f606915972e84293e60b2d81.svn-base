    ...
    <tr>
      ...
      <table width="80%" border="0" align="center" cellpadding="0" cellspacing="10">
        ...
        <tr>
          ...
          <td align="left">
          <ww:textfield name="domain.moCode"  size="40" cssClass="required max-length-20"/>
          </td>
          </tr>
        <tr>
          <td align="left" valign="top">模块名称：</td>
          <td align="left">
        <ww:textfield name="domain.moName"  size="40" cssClass="required max-length-40"/>
          </td>
          </tr>
        <tr>
        ...
        <ww:textfield name="domain.pmoCode"  readonly="true" size="40"/>
          ...
          <td align="left">
        <ww:textfield name="domain.flowCname"  size="40" cssClass="required max-length-40"/>
          </td>
          </tr>
           <tr>
          <td align="left" valign="top">表单地址：</td>
          <td align="left">
        <ww:textfield name="domain.fromUrl"  size="40" cssClass="required max-length-200"/>
          </td>
          </tr>                                                 
      </table></td>
    </tr>
    <tr>
      ...
      <table width="80%" border="0" align="center" cellpadding="0" cellspacing="10">
        <tr>
          ...
          <ww:textarea name="domain.remark" cols="50" rows="5" cssClass="required max-length-200"/>
          </td>
        </tr>
      </table>
      </td>
