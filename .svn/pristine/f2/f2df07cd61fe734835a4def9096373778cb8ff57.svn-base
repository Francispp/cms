			...
			cellspacing="1">
				  ...
				  <div id="Dtopm3" style="display:none; width:100%;height: 90% "> 
					  <table width="90%" border="0" align="left" cellpadding="0"
						cellspacing="10">
						<tr>
							<td  width="18%" align="left" class="inside_list">列表样式类型：</td>
						...
						<tr>
							<td colspan="2" id="definetd" style="display: none;">
								 <table width="100%" border="0" align="left" cellpadding="0"
									cellspacing="0">
									<tr>
										<td width="21%" align="left" valign="top" class="inside_list">头部HTML代码：</td>
										<td width="79%" align="left"><ww:textarea
											name="domain.pageTop" cols="90" rows="5" /></td>
									</tr> 
								    <tr>
									...
									<tr>
										<td valign="top" class="inside_list">页脚HTML代码：</td>
										<td align="left"><ww:textarea name="domain.pageFoot" cols="90" rows="5"/></td>
									</tr> 
								</table> 
							</td>
						</tr> 
