...
public class CrawlSettingsSAXHandler extends DefaultHandler implements
    ...
    private static Logger logger = Logger
            .getLogger("com.cyberway.issue.crawler.settings.XMLSettingsHandler");
     ...
     * (non-Javadoc)
     *
     * @see com.cyberway.issue.crawler.settings.ValueErrorHandler#handleValueError(com.cyberway.issue.crawler.settings.Constraint.FailedCheck)
     */
