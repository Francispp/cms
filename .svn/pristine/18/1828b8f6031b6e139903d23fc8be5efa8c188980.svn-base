...
import com.cyberway.issue.util.SubList;
...
public abstract class ListType<T> extends Type implements List<Object> {
    ...
    /* (non-Javadoc)
     * @see com.cyberway.issue.crawler.settings.Type#getDescription()
     */
     ...
     *
     * @return null
     * @see com.cyberway.issue.crawler.settings.Type#getLegalValues()
     */
