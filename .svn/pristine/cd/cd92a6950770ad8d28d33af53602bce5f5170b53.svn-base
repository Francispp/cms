 ...
 *       {@link com.cyberway.issue.crawler.framework.Filter} class.
...
public class MapType extends ComplexType {
    ...
    /* (non-Javadoc)
     * @see com.cyberway.issue.crawler.settings.Type#addConstraint(com.cyberway.issue.crawler.settings.Constraint)
     */
    ...
    /* (non-Javadoc)
     * @see com.cyberway.issue.crawler.settings.Type#getConstraints()
     */
