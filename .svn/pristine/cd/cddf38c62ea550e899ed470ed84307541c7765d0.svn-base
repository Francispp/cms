/* $Id: Arc2Warc.java 5800 2008-03-26 01:04:12Z gojomo $
 *
 * Created Aug 29, 2006
 *
...
import com.cyberway.issue.io.arc.ARCConstants;
import com.cyberway.issue.io.arc.ARCReader;
import com.cyberway.issue.io.arc.ARCReaderFactory;
import com.cyberway.issue.io.arc.ARCRecord;
 ...
 * @author stack
 * @version $Date: 2008-03-26 01:04:12 +0000 (Wed, 26 Mar 2008) $ $Revision: 5800 $
 */
public class Arc2Warc {
   private static void usage(HelpFormatter formatter, Options options,
           int exitCode) {
       formatter.printHelp("java com.cyberway.issue.io.arc.Arc2Warc " +
       		"[--force] ARC_INPUT WARC_OUTPUT", options);
       System.exit(exitCode);
   }
   
   private static String getRevision() {
       return Warc2Arc.parseRevision("$Revision: 5800 $");
   }
