...
<script type="text/javascript">			
 ...
 if(confirm('您确定要清空选择的记录吗？')){
  location.href='/cms/channel!cleanup.action?siteid=${siteid}&keys='+ids+parameterUrl;
 }
 }
 ...
 if(confirm('您确定要还原选择的记录吗？')){
  location.href='${ctx}/cms/channel!revivification.action?siteid=${siteid}&keys='+ids+parameterUrl;
 }
...
<div class="system-header">
  ...
  <div class="info-box">
				...
				<ec:table items="items" var="item"
					action="${ctx}/cms/channel!recycle.action"
					updateAction="${ctx}/cms/channel!saveAjax.action"
					deleteAction="${ctx}/cms/channel!deleteAjax.action"
					insertAction="${ctx}/cms/channel!saveAjax.action" editable="false"
