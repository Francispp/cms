 ...
 *
 * $Id: XMLSettingsHandlerTest.java 3704 2005-07-18 17:30:21Z stack-sf $
 *
...
import com.cyberway.issue.crawler.framework.CrawlScope;
import com.cyberway.issue.crawler.scope.ClassicScope;
import com.cyberway.issue.crawler.settings.refinements.Criteria;
import com.cyberway.issue.crawler.settings.refinements.PortnumberCriteria;
import com.cyberway.issue.crawler.settings.refinements.Refinement;
import com.cyberway.issue.crawler.settings.refinements.RegularExpressionCriteria;
import com.cyberway.issue.crawler.settings.refinements.TimespanCriteria;
