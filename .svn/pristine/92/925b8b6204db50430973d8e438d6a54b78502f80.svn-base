	   ...
	   this.views = [
		...
		this.addEvent ("onPageInitialize", function (component)
		{
			if (component)
			{
				...
				$("checkField").value = GetAttribute (component, "checkField");
				...
				$A($("htmlEdit").options).each (function (option)
						{
							option.selected = option.value == GetAttribute (component, "htmlEdit");
						});
		...
		this.addEvent ("onComponentInitialize", function (component)
		{
			...
			SetAttribute(component, "checkField", $("checkField").getValue ());
			...
			SetAttribute(component, "htmlEdit", $("htmlEdit").getValue ());
