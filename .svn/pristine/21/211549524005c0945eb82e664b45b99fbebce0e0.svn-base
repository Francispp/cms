...
public class XMLFilterBase extends XMLFilterImpl implements LexicalHandler {
	 ...
	 * followed by {@link #characters(String)}, followed by
	 * {@link @see org.xml.sax.ContentHandler#endElement}.
	 * </p>
	 * 
	 * @param uri
	 *            The element's Namespace URI.
	 ...
	 * character array, then invokes
	 * {@link @see org.xml.sax.ContentHandler#characters}.
	 * </p>
	 * 
	 * @param data
	 *            The character data.
	 ...
	 * "[dtd]". @exception org.xml.sax.SAXException If a filter further down the
	 ...
	 * 
	 * @param name The name of the entity that is ending. @exception
	 * org.xml.sax.SAXException If a filter further down the chain raises an
	 * exception.
	 * 
	 ...
	 * 
	 * @param ch An array holding the characters in the comment. @param start
	 * The starting position in the array. @param length The number of
	 * characters to use from the array. @exception org.xml.sax.SAXException If
