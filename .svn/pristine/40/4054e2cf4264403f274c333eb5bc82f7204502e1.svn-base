 ...
 */
package com.cyberway.issue.crawler.event;
 ...
 *
 * @see com.cyberway.issue.crawler.framework.CrawlController#addCrawlStatusListener(CrawlStatusListener)
 */
...
public interface CrawlStatusListener {
     ...
     * {@link com.cyberway.issue.crawler.admin.CrawlJob#STATUS_WAITING_FOR_PAUSE
     ...
     *
     * @param statusMessage Should be
     * {@link com.cyberway.issue.crawler.admin.CrawlJob#STATUS_PAUSED}. Passed for
     * convenience
     */
     ...
     *
     * @param statusMessage Should be
     * {@link com.cyberway.issue.crawler.admin.CrawlJob#STATUS_RUNNING}. Passed for
     * convenience
     */
