...
import com.cyberway.issue.crawler.deciderules.recrawl.IdenticalDigestDecideRule;
import com.cyberway.issue.crawler.event.CrawlStatusListener;
import com.cyberway.issue.crawler.extractor.Link;
import com.cyberway.issue.crawler.framework.WriterPoolProcessor;
...
import com.cyberway.issue.io.WriterPoolSettings;
import com.cyberway.issue.io.warc.WARCWriter;
import com.cyberway.issue.io.warc.WARCConstants;
import com.cyberway.issue.io.warc.WARCWriterPool;
import com.cyberway.issue.uid.GeneratorFactory;
import com.cyberway.issue.util.ArchiveUtils;
import com.cyberway.issue.util.XmlUtils;
import com.cyberway.issue.util.anvl.ANVLRecord;
...
WriterPoolSettings, FetchStatusCodes, WARCConstants {
     ...
     * 
     * @see com.cyberway.issue.crawler.framework.WriterPoolProcessor#getFirstrecordBody(java.io.File)
     */
    @Override
