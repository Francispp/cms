...
*/
package com.cyberway.issue.extractor;
...
public abstract class CharSequenceLinkExtractor implements LinkExtractor {
    ...
    /* (non-Javadoc)
     * @see com.cyberway.issue.extractor.LinkExtractor#setup(com.cyberway.issue.crawler.datamodel.UURI, java.io.InputStream, java.nio.charset.Charset)
     */
    ...
    /* (non-Javadoc)
     * @see com.cyberway.issue.extractor.LinkExtractor#nextLink()
     */
